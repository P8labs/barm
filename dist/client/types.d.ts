...
export type ResourceClient<TResource extends ResourceManagerConstraint> = {
    ...
    create: (data: TResource["schema"]["_input"]) => Promise<TResource["schema"]["_output"]>;
    update: (params: {
        id: string;
...
export type ResourceManagerActions<TResources extends Record<string, ResourceManagerConstraint>> = {
    resourceManager: {
